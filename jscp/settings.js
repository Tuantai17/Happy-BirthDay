...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            {
                image: './image/page4.png',
                content: ''
            },
            {
                image: './image/page5.png',
                content: ''
            }
        ]
    };
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    createPages();
    // Chạy chế độ offline 100% cho cấu hình ID 686cc6e8abdac90e614264c1
    ...
    // Gọi hàm khởi chạy trang web lập tức
